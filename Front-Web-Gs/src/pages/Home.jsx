...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* CONTAINER PRINCIPAL */}
      <div className="p-6 bg-[#e8f5e9] dark:bg-[#1d261d] min-h-screen transition-colors flex flex-col items-center">
        
        <h1 className="text-3xl font-bold mb-8 text-gray-700 dark:text-white font-sans">Profissionais</h1>
      ...
      {selectedUser && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold mb-2 pr-8 text-gray-700 dark:text-gray-800 font-sans">{selectedUser.nome}</h2>
            <p className="text-sm text-gray-600 dark:text-gray-600 mb-3 font-sans">{selectedUser.cargo}</p>
            ...
            <h3 className="text-lg font-bold text-gray-700 dark:text-gray-800 font-sans">Informações Pessoais</h3>
            <p className="text-sm text-gray-600 dark:text-gray-600 font-sans"><strong>Local:</strong> {selectedUser.localizacao}</p>

            <h3 className="text-lg font-bold mt-3 text-gray-700 dark:text-gray-800 font-sans">Formação Acadêmica</h3>
            ...
            <h3 className="text-lg font-bold mt-3 text-gray-700 dark:text-gray-800 font-sans">Experiências</h3>
              ...
              {selectedUser.experiencias && selectedUser.experiencias.length > 0 ? (
                selectedUser.experiencias.map((exp, i) => (
                  <li key={i} className="mb-1 font-sans">
                    ...
                    {exp.descricao && <p className="text-xs text-gray-600 dark:text-gray-500 mt-1 font-sans">{exp.descricao}</p>}
                  </li>
                ))
              ) : (
            ...
            <h3 className="text-lg font-bold mt-3 text-gray-700 dark:text-gray-800 font-sans">Soft Skills</h3>
            <p className="text-sm text-gray-600 dark:text-gray-600 font-sans"><strong>Soft Skills:</strong> {selectedUser.softSkills.join(", ")}</p>
  ...
  return (
    ...
    >
      <div className="p-4 flex justify-center shrink-0">
        <img src={user.foto} alt={user.nome} className="w-56 h-56 aspect-square object-cover border-2 border-gray-200 rounded-lg" />
      </div>
      <div className="p-4 flex flex-col grow">
        <h2 className="text-base font-bold text-gray-700 dark:text-gray-800 mb-1 font-sans">{user.nome}</h2>
        <p className="text-sm text-gray-600 dark:text-gray-600 mb-2 font-sans">{user.cargo}</p>
