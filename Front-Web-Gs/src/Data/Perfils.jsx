...
area: "Tecnologia",
habilidadesTecnicas: ["Java", "Spring", "React"],
softSkills: ["Comunicação", "Liderança"],
experiencias: [
  { empresa: "TechCorp", cargo: "Desenvolvedora", inicio: "2021-01", fim: "2023-06", descricao: "Desenvolvimento de APIs e sistemas web." }
],
formacao: [
  { curso: "Bacharelado em Ciência da Computação", instituicao: "USP", ano: 2020 }
],
projetos: [
  { titulo: "Sistema de gestão escolar", link: "https://github.com/proj1", descricao: "Plataforma para escolas." }
],
certificacoes: ["AWS Practitioner"],
idiomas: [
  { idioma: "Inglês", nivel: "Avançado" }
],
areaInteresses: ["IA", "Computação em nuvem"]
},
{
id: 2,
nome: "Bruno Oliveira Martins",
foto: "https://dicionariompb.com.br/wp-content/uploads/2021/04/luan-santana-e1640563543767.jpeg",
cargo: "UI/UX Designer",
resumo: "Designer voltado para acessibilidade.",
localizacao: "Rio de Janeiro/RJ",
area: "Design",
habilidadesTecnicas: ["Figma", "Adobe XD", "UX Research"],
softSkills: ["Empatia", "Comunicação"],
experiencias: [
  { empresa: "DesignLab", cargo: "UX Designer", inicio: "2020-05", fim: "2024-02", descricao: "Pesquisa e prototipação de interfaces." }
],
formacao: [
  { curso: "Design Digital", instituicao: "PUC-Rio", ano: 2019 }
],
projetos: [
  { titulo: "App de acessibilidade", link: "https://github.com/proj2", descricao: "Ferramenta para inclusão digital." }
],
certificacoes: ["Google UX Certification"],
idiomas: [
  { idioma: "Inglês", nivel: "Intermediário" }
],
areaInteresses: ["Design inclusivo", "Experiência do usuário"]
},
{
id: 3,
nome: "Carla Nogueira",
...
area: "Dados",
habilidadesTecnicas: ["Python", "Pandas", "TensorFlow"],
softSkills: ["Pensamento analítico", "Trabalho em equipe"],
experiencias: [
  { empresa: "DataPlus", cargo: "Data Scientist", inicio: "2019-01", fim: "2024-05", descricao: "Desenvolvimento de modelos preditivos." }
],
formacao: [
  { curso: "Mestrado em Data Science", instituicao: "UFMG", ano: 2018 }
],
projetos: [
  { titulo: "Predição de churn", link: "https://github.com/proj3", descricao: "Modelo preditivo para clientes." }
],
certificacoes: ["TensorFlow Developer"],
idiomas: [
  { idioma: "Inglês", nivel: "Avançado" }
],
areaInteresses: ["Machine Learning", "Data Ethics"]
},
{
id: 4,
...
habilidadesTecnicas: ["Kotlin", "Swift", "Flutter"],
softSkills: ["Criatividade", "Comunicação"],
experiencias: [
  { empresa: "AppWorks", cargo: "Mobile Developer", inicio: "2020-03", fim: "2024-06", descricao: "Desenvolvimento de aplicativos multiplataforma." }
],
formacao: [
  { curso: "Engenharia de Software", instituicao: "UTFPR", ano: 2019 }
],
projetos: [
  { titulo: "App de entrega rápida", link: "https://github.com/proj4", descricao: "Aplicativo estilo delivery." }
],
certificacoes: ["Google Mobile Certification"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Automação", "Mobile First"]
},
{
id: 5,
nome: "Eduarda Cruz",
...
area: "Gestão",
habilidadesTecnicas: ["PMBOK", "Scrum", "Kanban"],
softSkills: ["Liderança", "Comunicação", "Empatia"],
experiencias: [
  { empresa: "AgileCorp", cargo: "Project Manager", inicio: "2018-02", fim: "2024-06", descricao: "Gestão de squads ágeis." }
],
formacao: [
  { curso: "Administração", instituicao: "UnB", ano: 2017 }
],
projetos: [
  { titulo: "Sistema financeiro", link: "https://github.com/proj5", descricao: "Coordenação geral do projeto." }
],
certificacoes: ["PMP", "Scrum Master"],
idiomas: [{ idioma: "Inglês", nivel: "Fluente" }],
areaInteresses: ["Metodologias Ágeis", "Gestão de Pessoas"]
},
{
id: 6,
nome: "Felipe Moura",
...
softSkills: ["Pensamento crítico", "Comunicação"],
experiencias: [
  { empresa: "CloudNet", cargo: "DevOps", inicio: "2019-05", fim: "2024-06", descricao: "Automação de pipelines e deploys." }
],
formacao: [
  { curso: "Sistemas de Informação", instituicao: "UFC", ano: 2018 }
],
projetos: [
  { titulo: "Pipeline CI/CD", link: "https://github.com/proj6", descricao: "Automação completa com GitHub Actions." }
],
certificacoes: ["AWS SysOps", "CKA"],
idiomas: [{ idioma: "Inglês", nivel: "Avançado" }],
areaInteresses: ["Cloud", "SRE", "Infraestrutura"]
},
{
id: 7,
nome: "Gabriela Lima",
...
area: "Marketing",
habilidadesTecnicas: ["Google Ads", "Analytics", "SEO"],
softSkills: ["Criatividade", "Comunicação"],
experiencias: [
  { empresa: "MarketingHub", cargo: "Analista", inicio: "2020-01", fim: "2024-03", descricao: "Gestão de campanhas." }
],
formacao: [
  { curso: "Publicidade", instituicao: "UFBA", ano: 2019 }
],
projetos: [
  { titulo: "Campanha E-commerce", link: "https://github.com/proj7", descricao: "Estratégia completa de vendas." }
],
certificacoes: ["Google Ads Certification"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Branding", "Growth"]
},
{
id: 8,
nome: "Henrique Assis",
...
habilidadesTecnicas: ["Microservices", "Java", "Kafka"],
softSkills: ["Liderança técnica", "Comunicação"],
experiencias: [
  { empresa: "MegaTech", cargo: "Arquiteto", inicio: "2019-02", fim: "2024-06", descricao: "Projetou arquitetura de microserviços." }
],
formacao: [
  { curso: "Engenharia da Computação", instituicao: "USP", ano: 2017 }
],
projetos: [
  { titulo: "Sistema bancário distribuído", link: "https://github.com/proj8", descricao: "Plataforma tolerante a falhas." }
],
certificacoes: ["Oracle Architect"],
idiomas: [{ idioma: "Inglês", nivel: "Fluente" }],
areaInteresses: ["Microservices", "Cloud Native"]
},
{
id: 9,
nome: "Isabela Rocha",
...
localizacao: "Belo Horizonte/MG",
area: "Produto",
habilidadesTecnicas: ["Kanban", "Scrum", "Product Discovery"],
softSkills: ["Empatia", "Comunicação"],
experiencias: [
  { empresa: "ProdMax", cargo: "PO", inicio: "2021-01", fim: "2024-06", descricao: "Gestão de backlog e discovery." }
],
formacao: [
  { curso: "Administração", instituicao: "FUMEC", ano: 2020 }
],
projetos: [
  { titulo: "Produto SaaS B2B", link: "https://github.com/proj9", descricao: "Melhoria de fluxo de vendas." }
],
certificacoes: ["Product Owner - PSPO"],
idiomas: [{ idioma: "Espanhol", nivel: "Intermediário" }],
areaInteresses: ["Product Thinking", "UX"]
},
{
id: 10,
...
habilidadesTecnicas: ["React", "Next.js", "Tailwind"],
softSkills: ["Trabalho em equipe", "Comunicação"],
experiencias: [
  { empresa: "WebHub", cargo: "Frontend", inicio: "2020-02", fim: "2024-06", descricao: "Desenvolvimento de SPAs." }
],
formacao: [
  { curso: "Tecnologia da Informação", instituicao: "PUCRS", ano: 2019 }
],
projetos: [
  { titulo: "Dashboard Financeiro", link: "https://github.com/proj10", descricao: "Visualização de dados." }
],
certificacoes: ["React Developer"],
idiomas: [{ idioma: "Inglês", nivel: "Avançado" }],
areaInteresses: ["UI", "Arquitetura Front-end"]
},
{
id: 11,
nome: "Karla Menezes",
...
area: "Qualidade",
habilidadesTecnicas: ["Cypress", "Selenium", "Jest"],
softSkills: ["Organização", "Detalhismo"],
experiencias: [
  { empresa: "TestLab", cargo: "QA Analyst", inicio: "2020-01", fim: "2024-05", descricao: "Testes funcionais e automatizados." }
],
formacao: [
  { curso: "Sistemas de Informação", instituicao: "UFRN", ano: 2019 }
],
projetos: [
  { titulo: "Automação de regressão", link: "https://github.com/proj11", descricao: "Pipeline de testes automatizados." }
],
certificacoes: ["ISTQB"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Testes automatizados", "Qualidade"]
},
{
id: 12,
nome: "Lucas Freitas",
...
habilidadesTecnicas: ["Python", "PyTorch", "NLP"],
softSkills: ["Raciocínio lógico", "Comunicação"],
experiencias: [
  { empresa: "FinAI", cargo: "ML Engineer", inicio: "2019-04", fim: "2024-05", descricao: "Sistemas de IA para análise de risco." }
],
formacao: [
  { curso: "Engenharia Elétrica", instituicao: "USP", ano: 2018 }
],
projetos: [
  { titulo: "Modelo de detecção de fraude", link: "https://github.com/proj12", descricao: "Sistema preditivo para bancos." }
],
certificacoes: ["DeepLearning.AI"],
idiomas: [{ idioma: "Inglês", nivel: "Avançado" }],
areaInteresses: ["IA ética", "Modelos generativos"]
},
{
id: 13,
nome: "Mariana Couto",
...
habilidadesTecnicas: ["R&S", "People Analytics"],
softSkills: ["Comunicação", "Empatia"],
experiencias: [
  { empresa: "HumanTech", cargo: "Analista de RH", inicio: "2021-02", fim: "2024-06", descricao: "Contratação de perfis técnicos." }
],
formacao: [
  { curso: "Psicologia", instituicao: "UFRJ", ano: 2020 }
],
projetos: [
  { titulo: "Pipeline de contratação tech", link: "https://github.com/proj13", descricao: "Processo de contratação estruturado." }
],
certificacoes: ["People Analytics"],
idiomas: [{ idioma: "Inglês", nivel: "Básico" }],
areaInteresses: ["Cultura organizacional", "Desenvolvimento humano"]
},
{
id: 14,
nome: "Natan Ribeiro",
...
resumo: "Infraestrutura e segurança de redes.",
localizacao: "Florianópolis/SC",
area: "Infraestrutura",
habilidadesTecnicas: ["Cisco", "Firewall", "Linux"],
softSkills: ["Raciocínio lógico", "Proatividade"],
experiencias: [
  { empresa: "NetSecure", cargo: "Administrador de Redes", inicio: "2018-01", fim: "2024-06", descricao: "Gestão de redes corporativas." }
],
formacao: [
  { curso: "Redes de Computadores", instituicao: "IFSC", ano: 2017 }
],
projetos: [
  { titulo: "Monitoramento de redes", link: "https://github.com/proj14", descricao: "Sistema de monitoramento via Zabbix." }
],
certificacoes: ["CCNA"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Cybersecurity", "Automação de redes"]
},
{
id: 15,
nome: "Olívia Castro",
...
localizacao: "Curitiba/PR",
area: "Dados",
habilidadesTecnicas: ["Python", "Airflow", "Spark"],
softSkills: ["Comunicação", "Organização"],
experiencias: [
  { empresa: "DataWave", cargo: "Data Engineer", inicio: "2020-05", fim: "2024-06", descricao: "Construção de ETLs robustos." }
],
formacao: [
  { curso: "Engenharia de Computação", instituicao: "UFPR", ano: 2019 }
],
projetos: [
  { titulo: "Pipeline Big Data", link: "https://github.com/proj15", descricao: "Ingestão de dados distribuídos." }
],
certificacoes: ["Databricks Engineer"],
idiomas: [{ idioma: "Inglês", nivel: "Avançado" }],
areaInteresses: ["Big Data", "Computação distribuída"]
},
{
id: 16,
...
resumo: "Sistemas de alta performance.",
localizacao: "São Paulo/SP",
area: "Desenvolvimento",
habilidadesTecnicas: ["Go", "PostgreSQL", "Redis"],
softSkills: ["Trabalho em equipe", "Foco"],
experiencias: [
  { empresa: "HighScale", cargo: "Backend Engineer", inicio: "2019-02", fim: "2024-06", descricao: "APIs de alta escalabilidade." }
],
formacao: [
  { curso: "Ciência da Computação", instituicao: "UNIP", ano: 2018 }
],
projetos: [
  { titulo: "Sistema de mensageria", link: "https://github.com/proj16", descricao: "Fila de mensagens distribuída." }
],
certificacoes: ["Go Developer"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Performance", "Arquiteturas reativas"]
},
{
id: 17,
nome: "Queila Andrade",
...
area: "Segurança",
habilidadesTecnicas: ["Pentest", "SIEM", "Firewalls"],
softSkills: ["Detalhismo", "Responsabilidade"],
experiencias: [
  { empresa: "SecureIT", cargo: "Security Analyst", inicio: "2018-04", fim: "2024-06", descricao: "Auditorias e testes de segurança." }
],
formacao: [
  { curso: "Computação", instituicao: "UFRPE", ano: 2017 }
],
projetos: [
  { titulo: "Pentest corporativo", link: "https://github.com/proj17", descricao: "Simulação de ataques internos." }
],
certificacoes: ["CEH"],
idiomas: [{ idioma: "Inglês", nivel: "Avançado" }],
areaInteresses: ["Cybersecurity", "DevSecOps"]
},
{
id: 18,
nome: "Rafael Souza",
...
resumo: "Dashboards e visualização de dados.",
localizacao: "Campinas/SP",
area: "Business Intelligence",
habilidadesTecnicas: ["Power BI", "SQL", "ETL"],
softSkills: ["Comunicação", "Raciocínio lógico"],
experiencias: [
  { empresa: "InsightTech", cargo: "BI Analyst", inicio: "2019-06", fim: "2024-06", descricao: "Construção de dashboards executivos." }
],
formacao: [
  { curso: "Administração", instituicao: "PUC", ano: 2018 }
],
projetos: [
  { titulo: "Dashboard vendas", link: "https://github.com/proj18", descricao: "Análises financeiras dinâmicas." }
],
certificacoes: ["Power BI Analyst"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Data Visualization", "Business"]
},
{
id: 19,
nome: "Sara Ribeiro",
...
localizacao: "Rio de Janeiro/RJ",
area: "Tecnologia",
habilidadesTecnicas: ["Node.js", "React", "MongoDB"],
softSkills: ["Criatividade", "Resiliência"],
experiencias: [
  { empresa: "WebPlus", cargo: "Full Stack", inicio: "2020-01", fim: "2024-06", descricao: "Desenvolvimento ponta a ponta." }
],
formacao: [
  { curso: "Ciência da Computação", instituicao: "UERJ", ano: 2019 }
],
projetos: [
  { titulo: "Marketplace", link: "https://github.com/proj19", descricao: "Plataforma completa de comércio online." }
],
certificacoes: ["Full Stack Certification"],
idiomas: [{ idioma: "Espanhol", nivel: "Intermediário" }],
areaInteresses: ["Web", "UX"]
},
{
id: 20,
nome: "Thiago Gomes",
...
resumo: "Otimização de queries e tuning.",
localizacao: "Manaus/AM",
area: "Banco de Dados",
habilidadesTecnicas: ["Oracle", "SQL Server", "PostgreSQL"],
softSkills: ["Organização", "Proatividade"],
experiencias: [
  { empresa: "DBMaster", cargo: "DBA", inicio: "2017-03", fim: "2024-06", descricao: "Administração de grandes bases." }
],
formacao: [
  { curso: "Análise de Sistemas", instituicao: "UFAM", ano: 2016 }
],
projetos: [
  { titulo: "Data Warehouse", link: "https://github.com/proj20", descricao: "Projeto de BI corporativo." }
],
certificacoes: ["Oracle OCP"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Big Data", "SGBDs"]
},
{
id: 21,
nome: "Ursula Mendes",
...
localizacao: "São Paulo/SP",
area: "Agile",
habilidadesTecnicas: ["Scrum", "Kanban", "OKRs"],
softSkills: ["Comunicação", "Empatia"],
experiencias: [
  { empresa: "AgileWorks", cargo: "Scrum Master", inicio: "2019-02", fim: "2024-06", descricao: "Suporte a squads de desenvolvimento." }
],
formacao: [
  { curso: "Administração", instituicao: "Mackenzie", ano: 2018 }
],
projetos: [
  { titulo: "Implantação ágil", link: "https://github.com/proj21", descricao: "Transformação ágil corporativa." }
],
certificacoes: ["CSM"],
idiomas: [{ idioma: "Inglês", nivel: "Avançado" }],
areaInteresses: ["Agilidade", "Cultura Ágil"]
},
{
id: 22,
nome: "Victor Torres",
...
resumo: "Apaixonado por estatística.",
localizacao: "Goiânia/GO",
area: "Dados",
habilidadesTecnicas: ["Python", "Statsmodels", "SQL"],
softSkills: ["Curiosidade", "Pensamento crítico"],
experiencias: [
  { empresa: "DataGo", cargo: "Estagiário", inicio: "2022-01", fim: "2024-06", descricao: "Modelagem estatística." }
],
formacao: [
  { curso: "Estatística", instituicao: "UFG", ano: 2023 }
],
projetos: [
  { titulo: "Modelo linear", link: "https://github.com/proj22", descricao: "Predição acadêmica." }
],
certificacoes: [],
idiomas: [{ idioma: "Inglês", nivel: "Básico" }],
areaInteresses: ["Estatística", "Machine Learning"]
},
{
id: 23,
nome: "Wagner Lima",
foto: "https://dicionariompb.com.br/wp-content/uploads/2021/04/luan-santana-e1640563543767.jpeg",
cargo: "Dev Front-end Sênior",
resumo: "Foco em acessibilidade.",
localizacao: "Porto Alegre/RS",
area: "Desenvolvimento",
habilidadesTecnicas: ["React", "Vue", "Tailwind"],
softSkills: ["Comunicação", "Trabalho em equipe"],
experiencias: [
  { empresa: "FrontTech", cargo: "Senior Developer", inicio: "2017-06", fim: "2024-06", descricao: "Componentes acessíveis." }
],
formacao: [
  { curso: "Sistemas para Internet", instituicao: "Senac", ano: 2016 }
],
projetos: [
  { titulo: "Biblioteca UI", link: "https://github.com/proj23", descricao: "Componentes acessíveis reutilizáveis." }
],
certificacoes: ["React Expert"],
idiomas: [{ idioma: "Inglês", nivel: "Fluente" }],
areaInteresses: ["Design System", "Acessibilidade"]
},
{
id: 24,
nome: "Ximena Duarte",
...
localizacao: "São Paulo/SP",
area: "Dados",
habilidadesTecnicas: ["Spark", "Airflow", "Kafka"],
softSkills: ["Proatividade", "Análise crítica"],
experiencias: [
  { empresa: "DataPrime", cargo: "Engenheira", inicio: "2019-03", fim: "2024-06", descricao: "Sistemas distribuídos." }
],
formacao: [
  { curso: "Ciência da Computação", instituicao: "USP", ano: 2018 }
],
projetos: [
  { titulo: "Data Lake", link: "https://github.com/proj24", descricao: "Armazenamento distribuído." }
],
certificacoes: ["GCP Data Engineer"],
idiomas: [{ idioma: "Inglês", nivel: "Avançado" }],
areaInteresses: ["Big Data", "Arquitetura distribuída"]
},
{
id: 25,
nome: "Yago Fernandes",
...
resumo: "APIs robustas e seguras.",
localizacao: "Salvador/BA",
area: "Desenvolvimento",
habilidadesTecnicas: ["Java", "Spring Boot", "MySQL"],
softSkills: ["Foco", "Resiliência"],
experiencias: [
  { empresa: "BackTech", cargo: "Developer", inicio: "2020-01", fim: "2024-06", descricao: "APIs REST seguras." }
],
formacao: [
  { curso: "Engenharia da Computação", instituicao: "UFBA", ano: 2019 }
],
projetos: [
  { titulo: "Sistema financeiro", link: "https://github.com/proj25", descricao: "Transações bancárias." }
],
certificacoes: ["Java OCP"],
idiomas: [{ idioma: "Inglês", nivel: "Básico" }],
areaInteresses: ["Backend", "Segurança"]
},
{
id: 26,
nome: "Zara Mota",
...
localizacao: "Fortaleza/CE",
area: "Suporte",
habilidadesTecnicas: ["Linux", "Redes", "Atendimento"],
softSkills: ["Paciência", "Comunicação"],
experiencias: [
  { empresa: "HelpDesk Co", cargo: "Suporte", inicio: "2021-02", fim: "2024-06", descricao: "Atendimento técnico." }
],
formacao: [
  { curso: "Informática", instituicao: "IFCE", ano: 2020 }
],
projetos: [
  { titulo: "Central de chamados", link: "https://github.com/proj26", descricao: "Sistema de tickets." }
],
certificacoes: ["Linux Essentials"],
idiomas: [{ idioma: "Inglês", nivel: "Básico" }],
areaInteresses: ["Infraestrutura", "Suporte"]
},
{
id: 27,
nome: "Aline Rebouças",
...
localizacao: "São Paulo/SP",
area: "Cloud",
habilidadesTecnicas: ["AWS", "Terraform", "DevOps"],
softSkills: ["Comunicação", "Foco"],
experiencias: [
  { empresa: "Cloud9", cargo: "Cloud Engineer", inicio: "2018-01", fim: "2024-06", descricao: "Estruturas em nuvem." }
],
formacao: [
  { curso: "Sistemas de Informação", instituicao: "FATEC", ano: 2017 }
],
projetos: [
  { titulo: "Infra como código", link: "https://github.com/proj27", descricao: "Terraform AWS." }
],
certificacoes: ["AWS Architect"],
idiomas: [{ idioma: "Inglês", nivel: "Avançado" }],
areaInteresses: ["Cloud", "DevOps"]
},
{
id: 28,
nome: "Bruno Siqueira",
...
resumo: "Especializado em redes de grande porte.",
localizacao: "Rio de Janeiro/RJ",
area: "Infraestrutura",
habilidadesTecnicas: ["Cisco", "VPN", "Firewalls"],
softSkills: ["Pensamento crítico", "Comunicação"],
experiencias: [
  { empresa: "NetworkPlus", cargo: "Network Engineer", inicio: "2017-06", fim: "2024-06", descricao: "Redes corporativas." }
],
formacao: [
  { curso: "Redes de Computadores", instituicao: "Estácio", ano: 2016 }
],
projetos: [
  { titulo: "Roteamento avançado", link: "https://github.com/proj28", descricao: "Configuração de BGP." }
],
certificacoes: ["CCNP"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Telecom", "Infraestrutura"]
},
{
id: 29,
...
localizacao: "São Paulo/SP",
area: "Produto",
habilidadesTecnicas: ["Roadmap", "Product Discovery"],
softSkills: ["Empatia", "Visão sistêmica"],
experiencias: [
  { empresa: "ProdMaster", cargo: "PM", inicio: "2019-01", fim: "2024-06", descricao: "Gestão de produtos digitais." }
],
formacao: [
  { curso: "Administração", instituicao: "USP", ano: 2018 }
],
projetos: [
  { titulo: "App corporativo", link: "https://github.com/proj29", descricao: "Planejamento e estratégia." }
],
certificacoes: ["PSPO"],
idiomas: [{ idioma: "Inglês", nivel: "Fluente" }],
areaInteresses: ["UX", "Inovação"]
},
{
id: 30,
nome: "Daniel Pires",
...
resumo: "APIs, automações e web scraping.",
localizacao: "São Paulo/SP",
area: "Desenvolvimento",
habilidadesTecnicas: ["Python", "FastAPI", "Scrapy"],
softSkills: ["Lógica", "Foco"],
experiencias: [
  { empresa: "AutoSoft", cargo: "Python Dev", inicio: "2020-01", fim: "2024-06", descricao: "Automações internas." }
],
formacao: [
  { curso: "Engenharia de Computação", instituicao: "USP", ano: 2019 }
],
projetos: [
  { titulo: "Scraper de preços", link: "https://github.com/proj30", descricao: "Coleta de informações online." }
],
certificacoes: ["Python Pro"],
idiomas: [{ idioma: "Inglês", nivel: "Intermediário" }],
areaInteresses: ["Automações", "Data Engineering"]
},
{
